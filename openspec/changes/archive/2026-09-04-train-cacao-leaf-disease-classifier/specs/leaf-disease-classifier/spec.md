...
The training pipeline SHALL fit an image classification model using the `cacao-leaf-dataset` training subset and select the checkpoint with the best validation performance.
